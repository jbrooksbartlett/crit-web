defmodule CritWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CritWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CritWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CritWeb.Gettext, "errors", msg, opts)
    end
  end
